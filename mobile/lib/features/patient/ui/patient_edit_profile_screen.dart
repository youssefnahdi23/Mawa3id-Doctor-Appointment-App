...
/// Edit form for the signed-in patient (`GET`/`PUT /api/patients/me`). Email
/// and patient code are read-only. Reached from the Profile overview.
class PatientEditProfileScreen extends ConsumerStatefulWidget {
  const PatientEditProfileScreen({super.key});

  @override
  ConsumerState<PatientEditProfileScreen> createState() =>
      _PatientEditProfileScreenState();
}

class _PatientEditProfileScreenState
    extends ConsumerState<PatientEditProfileScreen> {
