...
public record SpecialtyResponse(Long id, String name, String nameAr, String nameFr, String description) {

    public static SpecialtyResponse from(Specialty specialty) {
        return new SpecialtyResponse(specialty.getId(), specialty.getName(),
                specialty.getNameAr(), specialty.getNameFr(), specialty.getDescription());
    }
}
