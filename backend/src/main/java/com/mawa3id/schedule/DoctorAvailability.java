...
/**
 * A recurring weekly availability window for a doctor, e.g. Monday 09:00–12:00.
 * The bookable slots are derived by slicing this window into the doctor's
 * {@code slotDurationMinutes}-long chunks.
 */
@Entity
